...
(function () {
    var namespace = "StripeCheckout.require".split("."), name = namespace[namespace.length - 1], base = this, i;
    ...
    "vendor/cookie" : function (exports, require, module) {
        ...
        cookie.remove = function (key, options) {
            if (cookie.get(key) !== undefined) {
                cookie.set(key, "", extend(options, { expires : -1 }));
                return true
            }
            return false
        };
...
StripeCheckout.require.define({
    "vendor/ready" : function (exports, require, module) {
        !function (name, definition) {if (typeof module != "undefined")module.exports = definition(); else if (typeof define == "function" && typeof define.amd == "object")define(definition); else this[name] = definition()}("domready", function (ready) {
...
StripeCheckout.require.define({
    "lib/helpers" : function (exports, require, module) {
        (function () {
            ...
            delurkWinPhone = function (fn) {return function () {return fn() && !helpers.isWindowsPhone()}};
            helpers = {
                userAgent                : window.navigator.userAgent,
                escape                   : function (value) {return value && ("" + value).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\"/g, "&quot;")},
                ...
                isiOSChrome              : function () {return /CriOS/.test(helpers.userAgent)},
                isiOSWebView             : function () {return /(iPhone|iPod|iPad).*AppleWebKit((?!.*Safari)|(.*\([^)]*like[^)]*Safari[^)]*\)))/i.test(helpers.userAgent)},
                isiOS                    : delurkWinPhone(function () {return /(iPhone|iPad|iPod)/i.test(helpers.userAgent)}),
                isiOSNative              : function () {return this.isiOS() && this.iOSNativeVersion() >= 3},
                isiPad                   : function () {return /(iPad)/i.test(helpers.userAgent)},
                isMac                    : delurkWinPhone(function () {return /mac/i.test(helpers.userAgent)}),
                isWindowsPhone           : function () {return /(Windows\sPhone|IEMobile)/i.test(helpers.userAgent)},
                isWindowsOS              : function () {return /(Windows NT \d\.\d)/i.test(helpers.userAgent)},
                isIE                     : function () {return /(MSIE ([0-9]{1,}[\.0-9]{0,})|Trident\/)/i.test(helpers.userAgent)},
                isChrome                 : function () {return "chrome"in window},
                isSafari                 : delurkWinPhone(function () {
                    var userAgent;
                    userAgent = helpers.userAgent;
                    return /Safari/i.test(userAgent) && !/Chrome/i.test(userAgent)
                }),
                isFirefox                : delurkWinPhone(function () {return helpers.firefoxVersion() != null}),
                ...
                isAndroidDevice          : delurkWinPhone(function () {return /Android/.test(helpers.userAgent)}),
                isAndroidWebView         : function () {return helpers.isAndroidChrome() && /Version\/\d+\.\d+/.test(helpers.userAgent)},
                isNativeWebContainer     : function () {return window.cordova != null || /GSA\/\d+\.\d+/.test(helpers.userAgent)},
                isSupportedMobileOS      : function () {return helpers.isiOS() || helpers.isAndroidDevice()},
                ...
                isInsideFrame            : function () {return window.top !== window.self},
                isFallback               : function () {
                ...
                isSmallScreen            : function () {return Math.min(window.screen.availHeight, window.screen.availWidth) <= 640 || /FakeCheckoutMobile/.test(helpers.userAgent)},
                ...
                requestAnimationFrame    : function (callback) {return (typeof window.requestAnimationFrame === "function" ? window.requestAnimationFrame(callback) : void 0) || (typeof window.webkitRequestAnimationFrame === "function" ? window.webkitRequestAnimationFrame(callback) : void 0) || window.setTimeout(callback, 100)},
...
StripeCheckout.require.define({
    "lib/rpc" : function (exports, require, module) {
        (function () {
            var RPC, helpers, tracker, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}}, __slice = [].slice;
            ...
            RPC = function () {
                ...
                RPC.prototype.invoke = function () {
                    ...
                    return this.ready(function (_this) {return function () {return _this.sendMessage(method, args)}}(this))
                };
                ...
                RPC.prototype.isAlive = function () {return true};
        ...
        (function () {
            ...
            getCookieID = function () {
                ...
                try {
                    ...
                    setCookie("cid", id, { expires : 360 * 20, domain : ".stripe.com" });
                    return id
                } catch (_error) {
                    err = _error;
                    return "NA"
            ...
            track = function (event, params, callback) {
                ...
                request_params = { event : event, rf : referrer, sc : search };
                for (k in params) {
                    v = params[k];
                    request_params[k] = v
                }
...
StripeCheckout.require.define({
    "lib/tracker" : function (exports, require, module) {
        (function () {
            var base64, config, isEventNameExisting, mixpanel, pixel, stateParameters, trace, traceSerialize, track, tracker, uuid, __indexOf = [].indexOf || function (item) {
            ...
            stateParameters = {};
            tracker = {};
            tracker.setEnabled = function (enabled) {return config.enabled = enabled};
            tracker.setTracingEnabled = function (enabled) {return config.tracingEnabled = enabled};
            tracker.setDistinctID = function (value) {
                if (value) {
                    return config.distinctId = value
                }
            };
            tracker.getDistinctID = function () {return config.distinctId};
            tracker.setMixpanelKey = function (mixpanelKey) {return config.mixpanelKey = mixpanelKey};
            tracker.track = {
                outerOpen                         : function (parameters) {
                    var requiredKeys;
                    requiredKeys = ["key"];
                    return track("outer.open", parameters, requiredKeys, { appendStateParameters : false })
                },
                ...
                close                             : function (parameters) {return track("close", parameters, ["withToken"])},
                rememberMe                        : function (parameters) {return track("checkbox.rememberMe", parameters, ["checked"])},
                authorizeAccount                  : function () {return track("account.authorize")},
                login                             : function () {return track("account.authorize.success")},
                wrongVerificationCode             : function () {return track("account.authorize.fail")},
                keepMeLoggedIn                    : function (parameters) {return track("checkbox.keepMeLoggedIn", parameters, ["checked"])},
                logout                            : function () {return track("account.logout")},
                submit                            : function () {return track("submit")},
                ...
                moreInfo                          : function () {return track("moreInfoLink.click")},
                accountCreateSuccess              : function () {return track("account.create.success")},
                accountCreateFail                 : function () {return track("account.create.fail")},
                addressAutocompleteShow           : function () {return track("addressAutoComplete.show")},
                addressAutocompleteResultSelected : function () {return track("addressAutocomplete.result.selected")},
                back                              : function (parameters) {return track("back", parameters, ["from_step", "to_step"])},
                token                             : function (parameters) {return track("token", parameters, ["stripe_token"])},
                i18nLocKeyMissing                 : function (key) {return track("i18n.loc.missingKey", { template_key : key })},
                ...
                phoneVerificationShow             : function () {return track("phoneVerification.show")},
                phoneVerificationCreate           : function (parameters) {return track("phoneVerification.create", parameters, ["use_sms"])},
                phoneVerificationAuthorize        : function (parameters) {return track("fraudCodeVerification.authorize", parameters, ["valid"])},
                addressVerificationShow           : function () {return track("addressVerification.show")},
                alert                             : function (parameters) {return track("alert", parameters)}
            };
            tracker.trace = {
                        ...
                        return this._triggerTimeout != null ? this._triggerTimeout : this._triggerTimeout = setTimeout(function (_this) {
                            return function () {
                                ...
                                for (eventName in _ref) {
                                    args = _ref[eventName];
                                    trace("trigger." + eventName, { args : args })
                                }
                                _this._triggerQueue = {};
                ...
                rpcInvoke      : function (method) {return trace("rpc.invoke." + method)},
            ...
            tracker.state = {
                setUIType                   : function (type) {return stateParameters["st-ui-type"] = type},
                setUIIntegration            : function (integration) {return stateParameters["st-ui-integration"] = integration},
                setAccountsEnabled          : function (bool) {return stateParameters["st-accounts-enabled"] = bool},
                ...
                setAccountCreated           : function (bool) {return stateParameters["st-account-created"] = bool},
                setLoggedIn                 : function (bool) {return stateParameters["st-logged-in"] = bool},
                ...
                setPhoneVerificationShown   : function (bool) {return stateParameters["st-phone-verification-shown"] = bool},
                setAddressVerificationShown : function (bool) {return stateParameters["st-address-verification-shown"] = bool},
                setAlipayShouldDisplay      : function (bool) {return stateParameters["st-alipay-should-display"] = bool},
                setRequestedLocale          : function (apiLocale, headerLocale) {
                    stateParameters["st-locale-api"] = apiLocale;
                    stateParameters["st-locale-header"] = headerLocale;
                    return stateParameters["st-locale-client"] = (window.navigator.languages || [])[0] || window.navigator.userLanguage || window.navigator.language || ""
                }
            };
            ...
            mixpanel.track = function (eventName, options) {
                ...
                properties = $.extend({ token : config.mixpanelKey, userAgent : window.navigator.userAgent }, options);
                delete properties["stripe_token"];
                dataStr = base64.encode(JSON.stringify({ event : eventName, properties : properties }));
            ...
            traceSerialize = function (value) {
                ...
                if (value instanceof Array) {
                    ...
                    return traceSerialize({ type : value.type, target_id : value.target.id })
...
StripeCheckout.require.define({
    "outer/lib/fallbackRpc" : function (exports, require, module) {
        (function () {
            var FallbackRPC, cacheBust, interval, lastHash, re, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}};
            cacheBust = 1;
            interval = null;
            lastHash = null;
            re = /^#?\d+&/;
                ...
                FallbackRPC.prototype.receiveMessage = function (callback, delay) {
                    ...
                    return interval = setInterval(function () {
                        ...
                        if (hash !== lastHash && re.test(hash)) {
                            ...
                            lastHash = hash;
                            return callback({ data : hash.replace(re, "") })
                        }
                    }, delay)
                };
                return FallbackRPC
...
StripeCheckout.require.define({
    "outer/lib/utils" : function (exports, require, module) {
        (function () {
            ...
            addClass = function (element, name) {return element.className += " " + name};
            hasClass = function (element, name) {return __indexOf.call(element.className.split(" "), name) >= 0};
            css = function (element, css) {return element.style.cssText += ";" + css};
            insertBefore = function (element, child) {return element.parentNode.insertBefore(child, element)};
            insertAfter = function (element, child) {return element.parentNode.insertBefore(child, element.nextSibling)};
            append = function (element, child) {return element.appendChild(child)};
...
StripeCheckout.require.define({
    "outer/controllers/app" : function (exports, require, module) {
        (function () {
            var App, Checkout, RPC, TokenCallback, tracker, utils, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}};
            ...
            App = function () {
                function App(options) {
                    ...
                    this.configurations = {};
                    this.checkouts = {};
                    this.host = "https://checkout.stripe.com";
                ...
                App.prototype.open = function (options, buttonId) {
                    ...
                    mergedOptions = { referrer : document.referrer, url : document.URL, timeLoaded : this.timeLoaded };
                    ...
                    if (buttonId) {
                        ...
                        checkout = new Checkout(new TokenCallback(options), this.host)
                    }
                ...
                App.prototype.configure = function (buttonId, options) {
                    ...
                    this.checkouts[buttonId] = new Checkout(new TokenCallback(options), this.host);
                    this.checkouts[buttonId].preload(options);
                    return {
                        open  : function (_this) {return function (options) {return _this.open(options, buttonId)}}(this),
                        close : function (_this) {return function () {return _this.close(buttonId)}}(this)
                    }
                };
                ...
                App.prototype.setHost = function (host) {return this.host = host};
                App.prototype.trackOpen = function (checkout, options) {
                    tracker.setEnabled(!options.notrack);
                    return tracker.track.outerOpen({ key : options.key, lsid : "NA", cid : "NA" })
                };
                return App
            }();
            module.exports = App
...
StripeCheckout.require.define({
    "outer/controllers/button" : function (exports, require, module) {
        (function () {
            var $$, Button, addClass, append, hasAttr, hasClass, helpers, insertAfter, parents, text, trigger, _ref, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}};
            ...
            Button = function () {
                ...
                Button.prototype.render = function () {
                    ...
                    this.$style.setAttribute("href", this.app.host + "/v3/checkout/button-qpwW2WfkB0oGWVWIASjIOQ.css");
                ...
                Button.prototype.append = function () {
                    ...
                    if (!this.nostyle) {
                        setTimeout(function (_this) {return function () {return _this.$el.style.visibility = "visible"}}(this), 1e3)
                    }
                    this.app.setHost(helpers.host(this.scriptEl.src));
                    return this.appHandler = this.app.configure(this.options, { form : this.$form })
                };
                Button.prototype.disable = function () {return this.$el.setAttribute("disabled", true)};
                Button.prototype.enable = function () {return this.$el.removeAttribute("disabled")};
                Button.prototype.isDisabled = function () {return hasAttr(this.$el, "disabled")};
                ...
                Button.prototype.open = function () {return this.appHandler.open(this.options)};
...
StripeCheckout.require.define({
    "outer/controllers/checkout" : function (exports, require, module) {
        (function () {
            var Checkout, FallbackView, IframeView, TabView, helpers, tracker, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}};
            helpers = require("lib/helpers");
            ...
            Checkout = function () {
                ...
                function Checkout(tokenCallback, host) {
                    this.onTokenCallback = __bind(this.onTokenCallback, this);
                    this.preload = __bind(this.preload, this);
                    this.open = __bind(this.open, this);
                    this.setOnToken = __bind(this.setOnToken, this);
                    var path, shouldPopup, viewClass;
                    this.host = host;
                    this.setOnToken(tokenCallback);
                    if (helpers.isFallback()) {
                        viewClass = FallbackView;
                        path = "/v3/fallback/lq2iVImRz0MPhGOrWd6SrA.html"
                    } else {
                        path = "/v3/VFHxEi2bjwX09bo64Gx8A.html";
                        if (Math.random() < .5) {
                            path = "/v3/var-lcxYbQi90a337mQZ3dcdzg.html"
                        }
                        shouldPopup = helpers.isSupportedMobileOS() && !(helpers.isNativeWebContainer() || helpers.isAndroidWebapp() || helpers.isiOSWebView() || helpers.isiOSBroken());
                        if (shouldPopup) {
                            viewClass = TabView
                        } else {
                ...
                Checkout.prototype.setOnToken = function (tokenCallback) {
                    ...
                    this.onToken = function (_this) {return function (data) {return tokenCallback.trigger(data.token, data.args, _this.onTokenCallback)}}(this);
                ...
                Checkout.prototype.open = function (options) {
                    ...
                    iframeFallback = function () {
                        ...
                        this.view = new IframeView(this.onToken, this.host, "/v3/VFHxEi2bjwX09bo64Gx8A.html");
                ...
                Checkout.prototype.preload = function (options) {return this.view.preload(options)};
                Checkout.prototype.onTokenCallback = function () {return this.view.triggerTokenCallback.apply(this.view, arguments)};
                return Checkout
            }();
...
StripeCheckout.require.define({
    "outer/controllers/tokenCallback" : function (exports, require, module) {
        (function () {
            var TokenCallback, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}};
            TokenCallback = function () {
                ...
                TokenCallback.prototype.supportsTokenCallback = function () {return this.version > 1};
...
StripeCheckout.require.define({
    "outer/views/fallbackView" : function (exports, require, module) {
        (function () {
            var FallbackRPC, FallbackView, View, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}}, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
...
StripeCheckout.require.define({
    "outer/views/iframeView" : function (exports, require, module) {
        (function () {
            var IframeView, RPC, View, helpers, ready, utils, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}}, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
                for (var key in parent) {
                    if (__hasProp.call(parent, key))child[key] = parent[key]
                }
                function ctor() {this.constructor = child}
            ...
            IframeView = function (_super) {
                    ...
                    return ready(function (_this) {
                        return function () {
                            ...
                            return _this.rpc.ready(function () {
                                ...
                                return _this.rpc.invoke("open", { timeLoaded : _this.options.timeLoaded }, function (success) {
                                    var _base;
                                    if (success) {
                                        return typeof(_base = _this.options).opened === "function" ? _base.opened() : void 0
                                    }
                                })
                            })
                        }
                ...
                IframeView.prototype.close = function () {return this.rpc.invoke("close")};
                ...
                IframeView.prototype.attachIframe = function () {
                    ...
                    helpers.bind(iframe, "load", function () {return iframe.style.visibility = "visible"});
                ...
                IframeView.prototype.removeTouchOverlay = function () {
                    ...
                    setTimeout(function () {return utils.remove(overlay)}, 400);
                ...
                IframeView.prototype.removeFrame = function () {
                    ...
                    frame = this.frame;
                    setTimeout(function () {return utils.remove(frame)}, 500);
                ...
                IframeView.prototype.configure = function () {
                    ...
                    this.rpc = new RPC(this.frame.contentWindow, { host : this.host });
                    this.rpc.methods.closed = this.closed;
                    return this.rpc.methods.setToken = this.setToken
                };
                IframeView.prototype.shouldShowTouchOverlay = function () {return helpers.isSupportedMobileOS()};
                return IframeView
            }(View);
...
StripeCheckout.require.define({
    "outer/views/tabView" : function (exports, require, module) {
        (function () {
            var RPC, TabView, View, helpers, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}}, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
                for (var key in parent) {
                    if (__hasProp.call(parent, key))child[key] = parent[key]
                }
                function ctor() {this.constructor = child}
            ...
            TabView = function (_super) {
                ...
                TabView.prototype.open = function (options, callback) {
                    ...
                    this.rpc = new RPC(this.frame, { host : this.host });
                ...
                TabView.prototype.fullPath = function () {return this.host + this.path};
...
StripeCheckout.require.define({
    "outer/views/view" : function (exports, require, module) {
        (function () {
            var View, __bind = function (fn, me) {return function () {return fn.apply(me, arguments)}}, __slice = [].slice;
            View = function () {
                ...
                View.prototype.open = function (options, callback) {return this.options = options};
...
(function () {
    var App, Button, app, require, _ref, _ref1;
    ...
    if (((_ref = this.StripeCheckout) != null ? _ref.__app : void 0) == null) {
        ...
        if (((_ref1 = this.StripeCheckout) != null ? _ref1.__host : void 0) && this.StripeCheckout.__host !== "") {
